...
from model.PeiqiModel import MokioMindConfig
from dataset.lm_data import PretrainDataset
...
def train_epoch(epoch, loader, iters, start_step=0, wandb=None):
    ...
    for step, (input_ids, labels, attention_mask) in enumerate(
        ...
        lr = get_lr(epoch * iters + step, args.epochs * iters, args.learning_rate)#余弦退火
        ...
        if step % args.accumulation_steps == 0:
            ...
            # scaler是梯度缩放器它不是优化器的替代品，而是给 optimizer 当保镖和中介的辅助工具
